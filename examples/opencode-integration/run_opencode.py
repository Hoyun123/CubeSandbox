...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--name",
        default="cube-opencode-agent-demo",
        help="OpenCode session name for the one-shot run.",
    )
    parser.add_argument(
        "--sandbox-timeout",
        type=int,
...
# CubeSandbox OpenCode Agent Smoke Project
...
def main() -> int:
    ...
    command = shell_join(
        ...
        opencode_command(args.prompt, mode="json", name=args.name),
    )
